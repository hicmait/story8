...
function Be() {
  ...
  function P(t, n) {
    return ee(t.type, n, void 0, void 0, void 0, t.props);
  }
  function I(t) {
  ...
  function O(t, n, s, a, f) {
        ...
        case "object":
          switch (t.$$typeof) {
            ...
            case c:
              ...
              break;
            case Y:
              return (l = t._init), O(l(t._payload), n, s, a, f);
          }
      }
    if (l)
      return (
    ...
    if (ne(t))
      for (var d = 0; d < t.length; d++)
        (a = t[d]), (y = k + Q(a, d)), (l += O(a, n, s, y, f));
    else if (((d = H(t)), typeof d == "function"))
      for (t = d.call(t), d = 0; !(a = t.next()).done; )
        (a = a.value), (y = k + Q(a, d++)), (l += O(a, n, s, y, f));
    else if (y === "object") {
      if (typeof t.then == "function") return O(N(t), n, s, a, f);
      throw (
        ((n = String(t)),
        Error(
  ...
  return (
    ...
    (p.StrictMode = U),
    (p.Suspense = re),
    (p.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = h),
    ...
    (p.cloneElement = function (t, n, s) {
      ...
      var a = K({}, t.props),
        ...
        y = void 0;
      if (n != null)
        for (l in (n.ref !== void 0 && (y = void 0),
      ...
      if (l === 1) a.children = s;
        ...
        for (var k = Array(l), d = 0; d < l; d++) k[d] = arguments[d + 2];
        a.children = k;
      }
    ...
    (p.createElement = function (t, n, s) {
      ...
      if (t && t.defaultProps)
        for (a in ((l = t.defaultProps), l)) f[a] === void 0 && (f[a] = l[a]);
    ...
    (p.useSyncExternalStore = function (t, n, s) {
      return h.H.useSyncExternalStore(t, n, s);
    }),
          ...
          (function () {
            ...
            function Z(e, r) {
              return (
                ...
                e._store && (r._store.validated = e._store.validated),
                r
              );
            }
            function S(e) {
            ...
            function P(e, r, o, u, i) {
                  ...
                  case "object":
                    switch (e.$$typeof) {
                      ...
                      case te:
                        ...
                        break;
                      case A:
                        return (_ = e._init), P(_(e._payload), r, o, u, i);
                    }
                }
              if (_) {
                (_ = e), (i = i(_));
                ...
                return (
                  Te(i)
                    ? ((o = ""),
                      R != null && (o = R.replace(Ce, "$&/") + "/"),
                      P(i, r, o, "", function (V) {
                        return V;
                      }))
                    : i != null &&
                      (S(i) &&
                        (i.key != null && ((_ && _.key === i.key) || W(i.key)),
                        (o = Z(
                          i,
                          o +
                            (i.key == null || (_ && _.key === i.key)
                              ? ""
                              : ("" + i.key).replace(Ce, "$&/") + "/") +
                            R
                        )),
              ...
              if (((_ = 0), (R = u === "" ? "." : u + ":"), Te(e)))
                ...
                for (
                  ...
                  (u = u.value), (v = R + h(u, m++)), (_ += P(u, r, o, v, i));
              else if (v === "object") {
                if (typeof e.then == "function") return P(ee(e), r, o, u, i);
                throw (
                  ((r = String(e)),
                  Error(
                    "Objects are not valid as a React child (found: " +
...
See https://react.dev/link/invalid-hook-call for tips about how to debug and fix this problem.`
            ...
            function q(e) {
              if (de === null)
                try {
                  ...
                  de = (T && T[r]).call(T, "timers").setImmediate;
                } catch {
                  de = function (u) {
                    Pe === !1 &&
                      ((Pe = !0),
            ...
            function $(e, r, o) {
              ...
              0 < E.thrownErrors.length
                ? ((u = N(E.thrownErrors)), (E.thrownErrors.length = 0), o(u))
                : r(e);
            }
            function X(e) {
              if (!he) {
            ...
            var C = {
              ...
              le;
            for (le in C) C.hasOwnProperty(le) && D(le, C[le]);
            ...
            var Oe,
              ke,
              Ae = {},
              qe = C["react-stack-bottom-frame"].bind(C, G)(),
              xe = be(z(G)),
              Se = !1,
              Ce = /\/+/g,
              je =
            ...
            (C = Object.freeze({
              ...
              (c.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE =
                E),
              (c.__COMPILER_RUNTIME = C),
              (c.act = function (e) {
                var r = E.actQueue,
                  o = _e;
                _e++;
                var u = (E.actQueue = r !== null ? r : []),
                  i = !1;
                try {
                  var v = e();
                } catch (m) {
                ...
                if (
                  ...
                  throw (
                    ((e = N(E.thrownErrors)), (E.thrownErrors.length = 0), e)
                  );
                return {
                  then: function (m, V) {
                    (i = !0),
              ...
              (c.cloneElement = function (e, r, o) {
                ...
                if (r != null) {
                  ...
                  e: {
                    if (
                      pe.call(r, "ref") &&
                      (_ = Object.getOwnPropertyDescriptor(r, "ref").get) &&
                      _.isReactWarning
                    ) {
                      _ = !1;
                      break e;
                ...
                if (R === 1) u.children = o;
                  ...
                  _ = Array(R);
                  for (var m = 0; m < R; m++) _[m] = arguments[m + 2];
                  u.children = _;
                }
                for (
                  u = F(
                  ...
                  (v = arguments[i]),
                    S(v) && v._store && (v._store.validated = 1);
                return u;
              }),
                  ...
                  Object.defineProperty(r, "displayName", {
                    ...
                    set: function (u) {
                      (o = u),
                        e.name ||
                          e.displayName ||
                          (Object.defineProperty(e, "name", { value: u }),
                          (e.displayName = u));
                    },
                  }),
                  r
              ...
              (c.useSyncExternalStore = function (e, r, o) {
                return g().useSyncExternalStore(e, r, o);
              }),
        ...
        (function () {
          ...
          function W(t, n, s, a, f, y, l, k) {
            return (
              ...
              (t._store = {}),
              Object.defineProperty(t._store, "validated", {
                configurable: !1,
                enumerable: !1,
                writable: !0,
                value: 0,
              ...
              Object.freeze && (Object.freeze(t.props), Object.freeze(t)),
              t
            );
          }
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
            ...
            if (
              ...
              s = {};
              for (var se in n) se !== "key" && (s[se] = n[se]);
            } else s = n;
            return (
              d &&
                j(
          ...
          var H = Qe(),
            ...
            g =
              H.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,
          ...
          var O,
            $ = {},
            X = H["react-stack-bottom-frame"].bind(H, w)(),
            x = N(U(w)),
            te = {};
          (ie.Fragment = B),
            (ie.jsx = function (t, n, s, a, f) {
...
var Ke = Ve();
const Ze = "_button_djmih_1",
  Je = "_primary_djmih_14",
  et = "_secondary_djmih_18",
  tt = "_success_djmih_22",
  rt = "_danger_djmih_26",
  Ue = {
    button: Ze,
    primary: Je,
  ...
  nt = ({ variant: T = "primary", label: c = "" }) =>
    /* @__PURE__ */ Ke.jsx("button", {
      className: `${Ue.button} ${Ue[T]}`,
      children: c,
    });
export { nt as UaButton };
